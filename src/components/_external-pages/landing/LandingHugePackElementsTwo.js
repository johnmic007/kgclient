...
const ScreenStyle = styled(MotionInView)(({ theme }) => ({
  paddingRight: 2,
  paddingBottom: 1,
  maxWidth: 300, // Adjust the maximum width here
  borderRadius: 12, // Adjust the border radius here
  backgroundColor: theme.palette.grey[theme.palette.mode === 'light' ? 300 : 800],
  [theme.breakpoints.up('sm')]: {
    maxWidth: 340, // Adjust the maximum width here
    paddingRight: 4,
    borderRadius: 24 // Adjust the border radius here
  },
  '& img': {
    borderRadius: 12,
    [theme.breakpoints.up('sm')]: {
...
export default function LandingHugePackElementsTwo() {
            ...
            <ContentStyle>
              ...
              <MotionInView variants={varFadeInUp}>
                <Typography variant="h2" sx={{ mb: 3 }}>
                  Refer 3 Friends - Pick: Smartwatch or Lenovo Tab <br />
                </Typography>
              </MotionInView>
