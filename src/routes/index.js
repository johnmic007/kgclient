...
import Company from '../pages/placement/Company';
import Drive from '../pages/placement/Drive';
import PlacementDetails from '../pages/placement/PlacementDetails';
import TrendingFacts from '../pages/trending-facts/TrendingFacts';
...
export default function Router() {
  ...
  let children = [
    { path: '/', element: <Navigate to="/dashboard/leads" replace /> },
    { path: 'app', element: <GeneralApp /> },
    { path: 'ecommerce', element: <GeneralEcommerce /> },
    { path: 'banking', element: <GeneralBanking /> },
    { path: 'booking', element: <GeneralBooking /> },
    { path: 'placement', element: <Placement /> },
    { path: 'facts', element: <TrendingFacts /> },
    { path: 'trainersLB', element: <TrainersLeaderBoard /> },
    { path: 'studentsLC', element: <StudentsLifeCycle /> },
    { path: 'myreferals', element: <MyReferals /> },
    { path: 'addreferals', element: <AddReferals /> },
    ...
    },
    {
      path: 'placement',
      children: [
        { path: '/', element: <Navigate to="/dashboard/placement/placementReport" replace /> },
        { path: 'placementReport', element: <Placement /> },
        { path: 'company', element: <Company /> },
        { path: 'drive', element: <Drive /> },
        { path: 'placementDetails', element: <PlacementDetails /> },
        { path: '/:name/edit', element: <UserCreate /> },
        { path: 'account', element: <UserAccount /> }
      ]
    },
